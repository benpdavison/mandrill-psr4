...
class Mandrill_Messages
{
     ...
     *
     * @param string      $raw_message        the full MIME document of an email message
     * @param null|string $from_email         optionally define the sender address - otherwise we'll use the address found in the provided headers
     * @param null|string $from_name          optionally define the sender alias
     * @param null|array  $to                 optionally define the recipients to receive the message - otherwise we'll use the To, Cc, and Bcc headers provided in the document
